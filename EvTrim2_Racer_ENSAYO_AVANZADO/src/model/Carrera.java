    ...
    public void clasificacionCarrera(Carrera carrera){
        ...
        for (Coche coche:listadoCoches) {
            ...
            if (coche.getPosicionCarrera()==1){
                ...
                coche.setCarrerasGanadasTotales(coche.getCarrerasGanadasTotales()+1);
                ...
                coche.setCarrerasSegundoTotales(coche.getCarrerasSegundoTotales()+1);
                coche.setNumeroPodios(coche.getNumeroPodios()+1);
                coche.setPuntosGeneral(coche.getPuntosGeneral()+6);
            } else if (coche.getPosicionCarrera()==3) {
                coche.setPuntosCarrera(4);
                coche.setCarrerasTerceroTotales(coche.getCarrerasTerceroTotales()+1);
                coche.setNumeroPodios(coche.getNumeroPodios()+1);
