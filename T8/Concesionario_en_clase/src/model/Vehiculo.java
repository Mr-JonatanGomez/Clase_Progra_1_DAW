...
public abstract class Vehiculo {
    ...
    public abstract void acelerar (int velocidad);// abstarct, solo puede si la clase lo es
    // todos lo tienen pero no esta definida, se hara en cada vehiculo individual
